...
{
  {
    ...
    EXPECT_EQ(Compare(AnyValue{SignedInteger8Type, 120},
                      AnyValue{SignedInteger64Type, 4000000000l}), CompareResult::Less);
    ...
    EXPECT_EQ(Compare(AnyValue{SignedInteger8Type, 120},
                      AnyValue{SignedInteger64Type, 120l}), CompareResult::Equivalent);
    ...
    EXPECT_EQ(Compare(AnyValue{SignedInteger8Type, 120},
                      AnyValue{SignedInteger64Type, 119l}), CompareResult::Greater);
  }
  {
    ...
    EXPECT_EQ(Compare(AnyValue{SignedInteger8Type, -119},
                      AnyValue{SignedInteger64Type, -20000l}), CompareResult::Greater);
  }
}
...
TEST_F(AnyValueComparisonTests, UnsignedIntegerTypes)
{
  ...
  EXPECT_EQ(Compare(AnyValue{UnsignedInteger8Type, 0},
                    AnyValue{UnsignedInteger64Type, 4000000000l}), CompareResult::Less);
  ...
  EXPECT_EQ(Compare(AnyValue{UnsignedInteger8Type, 120},
                    AnyValue{UnsignedInteger64Type, 120l}), CompareResult::Equivalent);
  ...
  EXPECT_EQ(Compare(AnyValue{UnsignedInteger8Type, 120},
                    AnyValue{UnsignedInteger64Type, 119l}), CompareResult::Greater);
}
